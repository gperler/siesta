...
class GeneratorConfig
{
    ...
    public static $OPTION_LIST = array(self::OPTION_DROP_UNUSED_TABLES, self::OPTION_ENTITY_FILE_SUFFX, self::OPTION_BASE_DIR, self::OPTION_CONNECTION_NAME, self::OPTION_MIGRATION_METHOD, self::OPTION_MIGRATION_TARGET_PATH);
    ...
    private static $ALLOWED_VALUES = array(self::MIGRATION_DIRECT_EXECUTION, self::MIGRATOR_CREATE_PHP_FILE, self::MIGRATOR_CREATE_SQL_FILE);
