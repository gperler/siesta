...
class ServiceFactoryEntity implements ArraySerializable
{

    const TABLE_NAME = "ServiceFactoryEntity";

    const DELIMIT_TABLE_NAME = "ServiceFactoryEntity";
    ...
    {
        $spCall = ($this->_existing) ? "CALL ServiceFactoryEntity_U(" : "CALL ServiceFactoryEntity_I(";
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(ServiceFactoryEntity $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
