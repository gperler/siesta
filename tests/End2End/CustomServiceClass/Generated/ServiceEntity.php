...
class ServiceEntity implements ArraySerializable
{

    const TABLE_NAME = "ServiceEntity";

    const DELIMIT_TABLE_NAME = "ServiceEntity";
    ...
    {
        $spCall = ($this->_existing) ? "CALL ServiceEntity_U(" : "CALL ServiceEntity_I(";
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(ServiceEntity $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
