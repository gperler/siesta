...
class SyliusShippingCategory implements ArraySerializable
{

    const TABLE_NAME = "sylius_shipping_category";
    ...
    {
        $spCall = ($this->_existing) ? "CALL sylius_shipping_category_U(" : "CALL sylius_shipping_category_I(";
        $connection = ConnectionFactory::getConnection($connectionName);
        $this->getId(true, $connectionName);
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->name) . ',' . Escaper::quoteString($connection, $this->description) . ',' . Escaper::quoteDateTime($this->createdAt) . ',' . Escaper::quoteDateTime($this->updatedAt) . ');';
    }
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusShippingCategory $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
