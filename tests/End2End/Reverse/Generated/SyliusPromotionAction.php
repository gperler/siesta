...
class SyliusPromotionAction implements ArraySerializable
{
    ...
    public function fromArray(array $data)
    {
        ...
        if ($933D0915139DF194Array !== null) {
            $933D0915139DF194 = SyliusPromotionService::getInstance()->newInstance();
    ...
    public function get933D0915139DF194(bool $forceReload = false)
    {
        if ($this->933D0915139DF194 === null || $forceReload) {
            $this->933D0915139DF194 = SyliusPromotionService::getInstance()->getEntityByPrimaryKey($this->promotionId);
        }
     ...
     * @return void
     */
    public function set933D0915139DF194(SyliusPromotion $entity = null)
    {
    ...
    /**
     * @param SyliusPromotionAction $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusPromotionAction $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
