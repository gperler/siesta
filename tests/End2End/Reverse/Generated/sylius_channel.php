...
class sylius_channel implements ArraySerializable
{
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_channel $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
