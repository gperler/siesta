...
class sylius_tax_category implements ArraySerializable
{

    const TABLE_NAME = "sylius_tax_category";
    ...
    {
        $spCall = ($this->_existing) ? "CALL sylius_tax_category_U(" : "CALL sylius_tax_category_I(";
        $connection = ConnectionFactory::getConnection($connectionName);
        $this->getId(true, $connectionName);
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->name) . ',' . Escaper::quoteString($connection, $this->description) . ',' . Escaper::quoteDateTime($this->created_at) . ',' . Escaper::quoteDateTime($this->updated_at) . ');';
    }
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_tax_category $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
