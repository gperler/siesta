...
class sylius_group implements ArraySerializable
{

    const TABLE_NAME = "sylius_group";
    ...
    {
        $spCall = ($this->_existing) ? "CALL sylius_group_U(" : "CALL sylius_group_I(";
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_group $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
