...
class sylius_locale implements ArraySerializable
{

    const TABLE_NAME = "sylius_locale";
    ...
    {
        $spCall = ($this->_existing) ? "CALL sylius_locale_U(" : "CALL sylius_locale_I(";
        $connection = ConnectionFactory::getConnection($connectionName);
        $this->getId(true, $connectionName);
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->code) . ',' . Escaper::quoteString($connection, $this->enabled) . ',' . Escaper::quoteDateTime($this->created_at) . ',' . Escaper::quoteDateTime($this->updated_at) . ');';
    }
    ...
    public function delete(string $connectionName = null)
    {
        ...
        $connection->execute("CALL sylius_locale_DB_PK($id)");
        $this->_existing = false;
    }
    ...
    {
        $this->code = StringUtil::trimToNull($code, 12);
    }
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_locale $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
