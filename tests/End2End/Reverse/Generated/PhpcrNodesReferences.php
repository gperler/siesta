...
class PhpcrNodesReferences implements ArraySerializable
{
    ...
    /**
     * @param PhpcrNodesReferences $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(PhpcrNodesReferences $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
