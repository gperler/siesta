...
class sylius_product_attribute implements ArraySerializable
{
    ...
    public function createSaveStoredProcedureCall(string $connectionName = null) : string
    {
        ...
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->name) . ',' . Escaper::quoteString($connection, $this->type) . ',' . Escaper::quoteString($connection, $this->configuration) . ',' . Escaper::quoteDateTime($this->created_at) . ',' . Escaper::quoteDateTime($this->updated_at) . ');';
    }
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_product_attribute $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
