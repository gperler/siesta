...
class SyliusCurrency implements ArraySerializable
{
    ...
    const COLUMN_EXCHANGERATE = "exchange_rate";
    ...
    public function createSaveStoredProcedureCall(string $connectionName = null) : string
    {
        ...
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->code) . ',' . Escaper::quoteFloat($this->exchangeRate) . ',' . Escaper::quoteString($connection, $this->enabled) . ',' . Escaper::quoteDateTime($this->createdAt) . ',' . Escaper::quoteDateTime($this->updatedAt) . ');';
    }
    ...
    public function fromResultSet(ResultSet $resultSet)
    {
        ...
        $this->exchangeRate = $resultSet->getFloatValue("exchange_rate");
    ...
    public function fromArray(array $data)
    {
        ...
        $this->setExchangeRate($arrayAccessor->getFloatValue("exchangeRate"));
     ...
     * @return void
     */
    public function setExchangeRate(float $exchangeRate = null)
    {
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusCurrency $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
