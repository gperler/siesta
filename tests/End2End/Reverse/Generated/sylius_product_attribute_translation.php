...
class sylius_product_attribute_translation implements ArraySerializable
{
    ...
    public function fromArray(array $data)
    {
        ...
        if ($93850EBA2C2AC5D3Array !== null) {
            $93850EBA2C2AC5D3 = sylius_product_attributeService::getInstance()->newInstance();
    ...
    public function get93850EBA2C2AC5D3(bool $forceReload = false)
    {
        if ($this->93850EBA2C2AC5D3 === null || $forceReload) {
            $this->93850EBA2C2AC5D3 = sylius_product_attributeService::getInstance()->getEntityByPrimaryKey($this->translatable_id);
        }
     ...
     * @return void
     */
    public function set93850EBA2C2AC5D3(sylius_product_attribute $entity = null)
    {
    ...
    /**
     * @param sylius_product_attribute_translation $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_product_attribute_translation $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
