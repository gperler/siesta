...
class SyliusPaymentMethodTranslation implements ArraySerializable
{
    ...
    public function createSaveStoredProcedureCall(string $connectionName = null) : string
    {
        ...
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteInt($this->translatableId) . ',' . Escaper::quoteString($connection, $this->name) . ',' . Escaper::quoteString($connection, $this->description) . ',' . Escaper::quoteString($connection, $this->locale) . ');';
    }
    ...
    public function fromArray(array $data)
    {
        ...
        if ($966BE3A12C2AC5D3Array !== null) {
            $966BE3A12C2AC5D3 = SyliusPaymentMethodService::getInstance()->newInstance();
    ...
    public function get966BE3A12C2AC5D3(bool $forceReload = false)
    {
        if ($this->966BE3A12C2AC5D3 === null || $forceReload) {
            $this->966BE3A12C2AC5D3 = SyliusPaymentMethodService::getInstance()->getEntityByPrimaryKey($this->translatableId);
        }
     ...
     * @return void
     */
    public function set966BE3A12C2AC5D3(SyliusPaymentMethod $entity = null)
    {
    ...
    /**
     * @param SyliusPaymentMethodTranslation $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusPaymentMethodTranslation $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
