...
class SyliusTaxonTranslation implements ArraySerializable
{
    ...
    public function createSaveStoredProcedureCall(string $connectionName = null) : string
    {
        ...
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteInt($this->translatableId) . ',' . Escaper::quoteString($connection, $this->name) . ',' . Escaper::quoteString($connection, $this->slug) . ',' . Escaper::quoteString($connection, $this->permalink) . ',' . Escaper::quoteString($connection, $this->description) . ',' . Escaper::quoteString($connection, $this->locale) . ');';
    }
    ...
    public function fromArray(array $data)
    {
        ...
        if ($1487DFCF2C2AC5D3Array !== null) {
            $1487DFCF2C2AC5D3 = SyliusTaxonService::getInstance()->newInstance();
    ...
    public function get1487DFCF2C2AC5D3(bool $forceReload = false)
    {
        if ($this->1487DFCF2C2AC5D3 === null || $forceReload) {
            $this->1487DFCF2C2AC5D3 = SyliusTaxonService::getInstance()->getEntityByPrimaryKey($this->translatableId);
        }
     ...
     * @return void
     */
    public function set1487DFCF2C2AC5D3(SyliusTaxon $entity = null)
    {
    ...
    /**
     * @param SyliusTaxonTranslation $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusTaxonTranslation $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
