...
class phpcr_nodes_weakreferences implements ArraySerializable
{
    ...
    /**
     * @param phpcr_nodes_weakreferences $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(phpcr_nodes_weakreferences $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
