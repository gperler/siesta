...
class sylius_order_identity implements ArraySerializable
{
    ...
    public function createSaveStoredProcedureCall(string $connectionName = null) : string
    {
        ...
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteInt($this->order_id) . ',' . Escaper::quoteString($connection, $this->name) . ',' . Escaper::quoteString($connection, $this->value) . ');';
    }
    ...
    public function fromArray(array $data)
    {
        ...
        if ($5757A18E8D9F6D38Array !== null) {
            $5757A18E8D9F6D38 = sylius_orderService::getInstance()->newInstance();
    ...
    public function get5757A18E8D9F6D38(bool $forceReload = false)
    {
        if ($this->5757A18E8D9F6D38 === null || $forceReload) {
            $this->5757A18E8D9F6D38 = sylius_orderService::getInstance()->getEntityByPrimaryKey($this->order_id);
        }
     ...
     * @return void
     */
    public function set5757A18E8D9F6D38(sylius_order $entity = null)
    {
    ...
    /**
     * @param sylius_order_identity $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_order_identity $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
