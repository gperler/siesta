...
class SyliusShippingMethodTranslation implements ArraySerializable
{
    ...
    public function fromArray(array $data)
    {
        ...
        if ($2B37DB3D2C2AC5D3Array !== null) {
            $2B37DB3D2C2AC5D3 = SyliusShippingMethodService::getInstance()->newInstance();
    ...
    public function get2B37DB3D2C2AC5D3(bool $forceReload = false)
    {
        if ($this->2B37DB3D2C2AC5D3 === null || $forceReload) {
            $this->2B37DB3D2C2AC5D3 = SyliusShippingMethodService::getInstance()->getEntityByPrimaryKey($this->translatableId);
        }
     ...
     * @return void
     */
    public function set2B37DB3D2C2AC5D3(SyliusShippingMethod $entity = null)
    {
    ...
    /**
     * @param SyliusShippingMethodTranslation $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusShippingMethodTranslation $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
