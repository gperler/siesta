...
class SyliusCountry implements ArraySerializable
{
    ...
    public function createSaveStoredProcedureCall(string $connectionName = null) : string
    {
        ...
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->isoName) . ',' . Escaper::quoteString($connection, $this->enabled) . ');';
    }
    ...
    {
        $this->isoName = StringUtil::trimToNull($isoName, 3);
    }
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusCountry $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
