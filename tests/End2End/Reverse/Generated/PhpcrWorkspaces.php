...
class PhpcrWorkspaces implements ArraySerializable
{

    const TABLE_NAME = "phpcr_workspaces";
    ...
    {
        $spCall = ($this->_existing) ? "CALL phpcr_workspaces_U(" : "CALL phpcr_workspaces_I(";
        $connection = ConnectionFactory::getConnection($connectionName);
        $this->getName(true, $connectionName);
        return $spCall . Escaper::quoteString($connection, $this->name) . ');';
    }
    ...
    /**
     * @param PhpcrWorkspaces $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(PhpcrWorkspaces $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
