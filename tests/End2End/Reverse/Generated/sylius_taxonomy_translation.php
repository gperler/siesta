...
class sylius_taxonomy_translation implements ArraySerializable
{
    ...
    public function fromArray(array $data)
    {
        ...
        if ($9F3F90D92C2AC5D3Array !== null) {
            $9F3F90D92C2AC5D3 = sylius_taxonomyService::getInstance()->newInstance();
    ...
    public function get9F3F90D92C2AC5D3(bool $forceReload = false)
    {
        if ($this->9F3F90D92C2AC5D3 === null || $forceReload) {
            $this->9F3F90D92C2AC5D3 = sylius_taxonomyService::getInstance()->getEntityByPrimaryKey($this->translatable_id);
        }
     ...
     * @return void
     */
    public function set9F3F90D92C2AC5D3(sylius_taxonomy $entity = null)
    {
    ...
    /**
     * @param sylius_taxonomy_translation $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_taxonomy_translation $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
