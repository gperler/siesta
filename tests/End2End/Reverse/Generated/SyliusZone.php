...
class SyliusZone implements ArraySerializable
{

    const TABLE_NAME = "sylius_zone";
    ...
    {
        $spCall = ($this->_existing) ? "CALL sylius_zone_U(" : "CALL sylius_zone_I(";
        $connection = ConnectionFactory::getConnection($connectionName);
        $this->getId(true, $connectionName);
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->name) . ',' . Escaper::quoteString($connection, $this->type) . ',' . Escaper::quoteString($connection, $this->scope) . ');';
    }
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusZone $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
