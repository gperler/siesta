...
class sylius_promotion_rule implements ArraySerializable
{
    ...
    public function fromArray(array $data)
    {
        ...
        if ($2C188EA8139DF194Array !== null) {
            $2C188EA8139DF194 = sylius_promotionService::getInstance()->newInstance();
    ...
    public function get2C188EA8139DF194(bool $forceReload = false)
    {
        if ($this->2C188EA8139DF194 === null || $forceReload) {
            $this->2C188EA8139DF194 = sylius_promotionService::getInstance()->getEntityByPrimaryKey($this->promotion_id);
        }
     ...
     * @return void
     */
    public function set2C188EA8139DF194(sylius_promotion $entity = null)
    {
    ...
    /**
     * @param sylius_promotion_rule $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_promotion_rule $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
