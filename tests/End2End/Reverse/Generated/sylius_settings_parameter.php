...
class sylius_settings_parameter implements ArraySerializable
{

    const TABLE_NAME = "sylius_settings_parameter";
    ...
    {
        $spCall = ($this->_existing) ? "CALL sylius_settings_parameter_U(" : "CALL sylius_settings_parameter_I(";
        $connection = ConnectionFactory::getConnection($connectionName);
        $this->getId(true, $connectionName);
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->namespace) . ',' . Escaper::quoteString($connection, $this->name) . ',' . Escaper::quoteString($connection, $this->value) . ');';
    }
    ...
    /**
     * @param sylius_settings_parameter $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_settings_parameter $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
