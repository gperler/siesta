...
class phpcr_workspaces implements ArraySerializable
{
    ...
    /**
     * @param phpcr_workspaces $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(phpcr_workspaces $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
