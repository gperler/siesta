...
class sylius_country implements ArraySerializable
{

    const TABLE_NAME = "sylius_country";
    ...
    {
        $spCall = ($this->_existing) ? "CALL sylius_country_U(" : "CALL sylius_country_I(";
        $connection = ConnectionFactory::getConnection($connectionName);
        $this->getId(true, $connectionName);
        return $spCall . Escaper::quoteInt($this->id) . ',' . Escaper::quoteString($connection, $this->iso_name) . ',' . Escaper::quoteString($connection, $this->enabled) . ');';
    }
    ...
    {
        $this->iso_name = StringUtil::trimToNull($iso_name, 3);
    }
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_country $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
