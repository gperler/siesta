...
class SyliusSettingsParameter implements ArraySerializable
{
    ...
    /**
     * @param SyliusSettingsParameter $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(SyliusSettingsParameter $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
