...
class sylius_product_archetype_translation implements ArraySerializable
{
    ...
    public function fromArray(array $data)
    {
        ...
        if ($E0BA36D2C2AC5D3Array !== null) {
            $E0BA36D2C2AC5D3 = sylius_product_archetypeService::getInstance()->newInstance();
    ...
    public function getE0BA36D2C2AC5D3(bool $forceReload = false)
    {
        if ($this->E0BA36D2C2AC5D3 === null || $forceReload) {
            $this->E0BA36D2C2AC5D3 = sylius_product_archetypeService::getInstance()->getEntityByPrimaryKey($this->translatable_id);
        }
     ...
     * @return void
     */
    public function setE0BA36D2C2AC5D3(sylius_product_archetype $entity = null)
    {
    ...
    /**
     * @param sylius_product_archetype_translation $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(sylius_product_archetype_translation $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
