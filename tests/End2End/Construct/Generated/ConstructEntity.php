...
class ConstructEntity implements ArraySerializable
{

    const TABLE_NAME = "ConstructEntity";

    const DELIMIT_TABLE_NAME = "ConstructEntity";
    ...
    {
        $spCall = ($this->_existing) ? "CALL ConstructEntity_U(" : "CALL ConstructEntity_I(";
    ...
    /**
     * @param ConstructEntity $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(ConstructEntity $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
