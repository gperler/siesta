...
class Artist implements ArraySerializable
{
    ...
    {
        $spCall = ($this->_existing) ? "CALL Artist_U(" : "CALL Artist_I(";
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(Artist $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
