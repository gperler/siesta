...
class ArtistUUID implements ArraySerializable
{

    const TABLE_NAME = "ArtistUUID";
    ...
    {
        $spCall = ($this->_existing) ? "CALL ArtistUUID_U(" : "CALL ArtistUUID_I(";
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(ArtistUUID $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
