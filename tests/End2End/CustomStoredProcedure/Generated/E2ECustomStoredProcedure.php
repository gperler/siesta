...
class E2ECustomStoredProcedure implements ArraySerializable
{

    const TABLE_NAME = "E2ECustomStoredProcedure";
    ...
    {
        $spCall = ($this->_existing) ? "CALL E2ECustomStoredProcedure_U(" : "CALL E2ECustomStoredProcedure_I(";
    ...
    /**
     * @param E2ECustomStoredProcedure $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(E2ECustomStoredProcedure $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
