...
class CartItemMPKService
{
     ...
     * @return void
     */
    public function deleteEntityByCartReference(string $cartId1, string $cartId2, string $id1 = null, string $id2 = null, string $connectionName = null)
    {
        $connection = ConnectionFactory::getConnection($connectionName);
        $cartId1 = Escaper::quoteString($connection, $cartId1);
        $cartId2 = Escaper::quoteString($connection, $cartId2);
        ...
        $id1 = Escaper::quoteString($connection, $id1);
        $id2 = Escaper::quoteString($connection, $id2);
        $connection->execute("CALL CartItemMPK_DB_R_cart($cartId1,$cartId2,$id1,$id2)");
    }
