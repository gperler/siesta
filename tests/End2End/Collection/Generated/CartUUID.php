...
class CartUUID implements ArraySerializable
{
     ...
     * @return void
     */
    public function deleteFromCartItem(string $id = null, string $connectionName = null)
    {
        CartItemUUIDService::getInstance()->deleteEntityByCartReference($this->getId(true, $connectionName), $id, $connectionName);
