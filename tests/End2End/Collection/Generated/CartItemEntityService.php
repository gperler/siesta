...
class CartItemEntityService
{
     ...
     * @return Cart[]
     */
    public function getEntityByCartReference(int $cartId, string $connectionName = null) : array
    {
        $connection = ConnectionFactory::getConnection($connectionName);
     ...
     * @return void
     */
    public function deleteEntityByCartReference(int $cartId, int $id = null, string $connectionName = null)
    {
        $connection = ConnectionFactory::getConnection($connectionName);
        $cartId = Escaper::quoteInt($cartId);
        $id = Escaper::quoteInt($id);
        $connection->execute("CALL CartItem_DB_R_cart($cartId,$id)");
    }
