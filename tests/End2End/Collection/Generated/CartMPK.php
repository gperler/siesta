...
class CartMPK implements ArraySerializable
{
     ...
     * @return void
     */
    public function deleteFromCartItem(string $id1 = null, string $id2 = null, string $connectionName = null)
    {
        CartItemMPKService::getInstance()->deleteEntityByCartReference($this->getId1(true, $connectionName), $this->getId2(true, $connectionName), $id1, $id2, $connectionName);
        if (($this->cartItem === null) OR ($id1 === null AND $id2 === null)) {
            $this->cartItem = null;
            return;
        }
