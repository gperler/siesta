...
class ExamMPK implements ArraySerializable
{

    const TABLE_NAME = "ExamMPK";
    ...
    {
        $spCall = ($this->_existing) ? "CALL ExamMPK_U(" : "CALL ExamMPK_I(";
    ...
    public function getStudentList(bool $forceReload = false, string $connectionName = null) : array
    {
        if ($this->studentList === null || $forceReload) {
            $this->studentList = StudentMPKService::getInstance()->getStudentMPKJoinStudentExamMPK($this->id1, $this->id2, $connectionName);
        }
     ...
     * @return void
     */
    public function addToStudentList(StudentMPK $entity)
    {
     ...
     * @return bool
     */
    public function arePrimaryKeyIdentical(ExamMPK $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
