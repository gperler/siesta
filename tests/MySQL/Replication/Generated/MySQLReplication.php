...
use SiestaTest\MySQL\Util\AttributeSerialize;
...
class MySQLReplication implements ArraySerializable
{

    const TABLE_NAME = "MySQLReplication";
    ...
    public function __construct()
    {
        ...
        $this->date = new SiestaDateTime('19-08-1977');
        $this->time = new SiestaDateTime('10:11:12');
    ...
    {
        $spCall = ($this->_existing) ? "CALL MySQLReplication_U(" : "CALL MySQLReplication_I(";
    ...
    /**
     * @param MySQLReplication $entity
     * 
     * @return bool
     */
    public function arePrimaryKeyIdentical(MySQLReplication $entity = null) : bool
    {
        if ($entity === null) {
            return false;
        }
